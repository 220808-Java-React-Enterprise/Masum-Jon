...
import com.revature.P1.servlets.AServlet;
...
public class ContextLoaderListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        AServlet loginServlet=new AServlet(mapper,new TokenService(new JwtConfig()),new UserService(new User_Daos()));
        ...
        context.addServlet("AServlet",loginServlet).addMapping("/auth");
